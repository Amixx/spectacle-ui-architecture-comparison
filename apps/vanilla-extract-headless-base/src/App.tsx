      ...
      <div className={styles.container}>
        <div className={styles.skinSwitcher}>
          <h3 className={styles.skinSwitcherTitle}>
            Vanilla Extract Headless Architecture - Base Theme
          </h3>
          <a href="http://localhost:5174" className={styles.themeLink}>
            Switch to Red Theme →
          </a>
        </div>
        ...
        <div className={styles.demoSection}>
          ...
          <FontConfig
            ...
            Input={Skin.Input}
            Select={Skin.Select}
            className={styles.fontConfig}
            gridClassName={styles.fontConfigGrid}
          />
