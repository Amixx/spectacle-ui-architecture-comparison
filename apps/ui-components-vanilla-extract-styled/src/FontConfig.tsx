...
import * as styles from './FontConfig.css';
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.grid}>
        ...
        >
          <Item key="graduate" textValue="GRADUATE"><span style={{ fontFamily: 'Graduate' }}>GRADUATE</span></Item>
          <Item key="roboto" textValue="Roboto"><span style={{ fontFamily: 'Roboto' }}>Roboto</span></Item>
          <Item key="inter" textValue="Inter"><span style={{ fontFamily: 'Inter' }}>Inter</span></Item>
          <Item key="courier" textValue="Courier"><span style={{ fontFamily: '"Courier Prime"' }}>Courier</span></Item>
        </Select>
